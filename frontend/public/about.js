...
`;
const successMessage = `${successIcon}<span style="color: green;">提交成功！</span>`;
const warningIcon = `
...
`;
const warningTsinghuaMessage = `${warningIcon}<span style="color: darkred;">目前仅支持清华邮箱！</span>`;
const warningInvalidMessage = `${warningIcon}<span style="color: darkred;">包含SQL关键字或非法字符！</span>`;
